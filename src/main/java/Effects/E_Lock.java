...
public class E_Lock extends Effect {
    ...
    public Effect applyEffect(Game game, Who selfPlayer) {
        ...
        if (super.conditionsFulfilled(game, selfPlayer)) {
            ...
            // 4. If required return expiryEffect using inverse TODO: Test the expiry effects extensively, as I think they might not work 100% of the time -> Lock is a good example...
            if (super.duration != null) {
                return new E_Lock(super.duration, super.target, !this.lock,null, super.timer, super.conditions);
            }
        }
        return null;
    }

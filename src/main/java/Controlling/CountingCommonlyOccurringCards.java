...
public class CountingCommonlyOccurringCards {
    ...
    */
    ...
    /*
    public static String[] fileNames_ComboZero = {
            "C:/Users/kabra/Desktop/Uni/Bachelor 2/GeneticCUEDeckBuilder/src/main/resources/Results/1_StandardRules/RepeatResidents_Rules1/currentCandidates - Kopie.csv",
            "C:/Users/kabra/Desktop/Uni/Bachelor 2/GeneticCUEDeckBuilder/src/main/resources/Results/1_StandardRules/RepeatResidents_Rules2/currentCandidates - Kopie.csv",
            "C:/Users/kabra/Desktop/Uni/Bachelor 2/GeneticCUEDeckBuilder/src/main/resources/Results/1_StandardRules/RepeatResidents_Rules3/currentCandidates - Kopie.csv",
    ...
    */
    ...
    public static String[] fileNames_NewRun = {
            "src/main/resources/Results/NewRun/FROM_null_WITH_r1_c0/currentCandidates.csv",
            "src/main/resources/Results/NewRun/FROM_null_WITH_r2_c0/currentCandidates.csv",
            "src/main/resources/Results/NewRun/FROM_null_WITH_r3_c0/currentCandidates.csv",
            "src/main/resources/Results/NewRun/FROM_r1_c0_WITH_r3_c0/currentCandidates.csv",
            "src/main/resources/Results/NewRun/FROM_r13_c0_WITH_r2_c0/currentCandidates.csv",
    };
    /*
        Comparing the 7_StandardComboZero, these occurred suspiciously often (500 is max possible):

            EMM034		7		93		92				96		 -> 288
            EWW036		67		92				81		7		 -> 247
            LVE032		92		90				93		95		 -> 370
            OCE009		79						91		95		 -> 265
            OCP002		93		96				91		94		 -> 374
            OSH001						97		89		91		 -> 277
            PFF012		94		92				67		79		 -> 332
            SMA025		92		95		93		96		95		 -> 471
            SOD016		95		94		92		97		88		 -> 466
            STE019		92		96				94		93		 -> 375

        10 cards occurred in at least 1 files and at least 200 times in total! (Out of 708 unique cards)
    */

    public static String[] fileNames = {
            "src/main/resources/Decks/NewResidents/res_3.csv",
    };


    public static int minTotalOccurrences = 10;
    public static int minOccurredInFiles  = 1;
